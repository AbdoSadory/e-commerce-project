...
function NameValidation(input) {
    ...
    if (inputValue.length < 5) handleError(input, 'please enter at least 5 character')
...
function emailValidation(input) {
    ...
    (regExp.test(inputValue) == false) ? handleError(input, "enter a valid email") : handleError(input)
